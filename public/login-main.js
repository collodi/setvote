...
var $author$project$Login$logInToJson = function (model) {
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'action',
				$elm$json$Json$Encode$string('signup')),
				_Utils_Tuple2(
				'email',
				$elm$json$Json$Encode$string(model.email)),
				_Utils_Tuple2(
						...
						[
							...
							_List_fromArray(
								[
									...
									$elm$html$Html$Events$onInput($author$project$Login$Email)
								]))
						]))
				])),
			$rundis$elm_bootstrap$Bootstrap$Grid$colBreak(
						...
						[
							...
							_List_fromArray(
								[
									...
									$elm$html$Html$Events$onInput($author$project$Login$Password)
								]))
						]))
				])),
			$rundis$elm_bootstrap$Bootstrap$Grid$colBreak(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$rundis$elm_bootstrap$Bootstrap$Grid$row,
				_List_Nil,
				model.authd ? $author$project$Login$viewLoggedIn(model) : $author$project$Login$viewLogin(model))
			]));
};
