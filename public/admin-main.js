...
var $author$project$Admin$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			default:
				var value = msg.a;
				var _v4 = A2($elm$json$Json$Decode$decodeValue, $elm$json$Json$Decode$bool, value);
				if (_v4.$ === 'Ok') {
					var authd_ = _v4.a;
					return _Utils_Tuple2(
						_Utils_update(
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{authd: false, msg: 'Error in parsing authd'}),
						$elm$core$Platform$Cmd$none);
				}
		}
	});
var $author$project$Admin$ToggleNewSet = {$: 'ToggleNewSet'};
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Who are you?')
									])),
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Go To Login Page')
									]))
							]))
					]))
